...
const SingleChatWrapper = Styled.div`
  ...
  .ninjadash-chatbox{
    ...
    .ninjadash-chatbox__single{
      ...
      .right{
        float: ${({ theme }) => (theme.rtl ? 'left' : 'right')};
        .ninjadash-chatbox__actions{
          margin: ${({ theme }) => (theme.rtl ? '0 0 0 15px' : '0 15px 0 0')};
        }
        .ninjadash-chatbox__name{
    ...
    .ninjadash-chatbox__contentInner{
      align-items: center;
...
const ChatSidebar = Styled.div`
  ...
  .custom-scrollbar{
    ...
    .ninjadash-track-vertical{
      ...
      top: 2px;
      border-radius: 3px;
      background: ${({ theme }) => theme[theme.mainContent]['scroll-bg']};
    }
  }
