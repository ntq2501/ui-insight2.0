            ...
            <a-row>
                <a-col :xs="24">
                    <sdCards title="Lịch sử điểm danh">
                        <a-row>
                            <a-col class="custom-card" :xxl="12" :xl="12" :lg="12" :md="12" :sm="24" :xs="24">
                            ...
                            <a-col class="custom-card" :xxl="6" :xl="12" :lg="12" :md="12" :sm="24" :xs="12">
                                <p class="card-title">Từ ngày</p>
                                <DatePickerWrapper>
                                    <a-date-picker :format="dateFormat" @change="onChange" class="padding-input-date" />
                                </DatePickerWrapper>
                            </a-col>
                            <a-col class="custom-card" :xxl="12" :xl="12" :lg="12" :md="12" :sm="24" :xs="12">
