            ...
            <a-row>
                <a-col :xs="24">
                    <sdCards title="Lịch sử điểm danh">
                        <a-row>
                            <a-col :xxl="6" :xl="12" :lg="12" :md="12" :sm="24" :xs="24">
                                <p class="card-title">Tình trạng</p>
                                <SelectWrapperStyle>
                                    <a-select v-model:value="valueSelected" @focus="focus" ref="select" @change="handleChange">
                            ...
                            <a-row>
                                <a-col :xxl="6" :xl="6" :lg="6" :md="6" :sm="12" :xs="12">
...
@media screen and (max-width: 600px) {
    ...
    #app > div > div > section > section > section > main > div > div > div > div > div > div.ant-card-body > div.ant-row > div.ant-row > div:nth-child(1) > datepickerwrapper > div
    div.ant-card-body > div.ant-row > div.ant-row > div:nth-child(1) > datepickerwrapper > div {
        min-width: none;
    }
}
