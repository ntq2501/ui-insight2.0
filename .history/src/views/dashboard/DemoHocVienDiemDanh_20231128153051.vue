            ...
            <a-row>
                <a-col :xs="24">
                    <sdCards title="Lịch sử điểm danh">
                        <a-row>
                            <a-col class="py-10 pr-10 pr-sm-0" :xxl="6" :xl="6" :lg="6" :md="6" :sm="24" :xs="24">
                            ...
                            <a-col :xxl="12" :xl="12" :lg="12" :md="12" :sm="24" :xs="24">
                                <a-row justify="space-between" class="datepicker-wapper" >
                                    <a-col :xxl="12" :xl="12" :lg="12" :md="12" :sm="12" :xs="12" class="px-5 p-sm-10">
                                        <p class="card-title">Từ ngày</p>
                                        <DatePickerWrapper>
                                            <a-date-picker :format="dateFormat" @change="onChange" class="padding-input-date" />
                                        </DatePickerWrapper>
                                    </a-col>
                                    <a-col :xxl="12" :xl="12" :lg="12" :md="12" :sm="12" :xs="12" class="px-5 px-sm-10">
