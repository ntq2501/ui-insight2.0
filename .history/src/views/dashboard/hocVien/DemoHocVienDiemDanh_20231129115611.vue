...
:global(#app > div > div > section > section > section > main > div > main > div > div > div > div.ant-card-body > div:nth-child(3) > ul) {
    margin: 0 !important;
}
...
:global(div.ant-card-body > div.ant-row > div.ant-col.ant-col-xs-24.ant-col-sm-24.ant-col-md-12.ant-col-lg-12.ant-col-xl-12.ant-col-xxl-12 > div > div > datepickerwrapper > div) {
    width: 100%;
}
