...
:global(#app > div > div > section > section > section > main > div > div > div > div > div > div.ant-card-body > div.jGPvQM > div > div > div > div > div > div > div > table > tbody > tr> td),
:global(div.ant-card-body > div.jGPvQM > div > div > div > div > div > div > div > table > thead > tr > th) {
    text-align: center;
}
:global(#app > div > div > section > section > section > main > div > div > div > div > div > div.ant-card-body > div:nth-child(3)) {
    text-align: end;
}
