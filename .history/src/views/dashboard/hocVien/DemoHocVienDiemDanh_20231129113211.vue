                ...
                <a-col :xs="24">
                    <sdCards title="Lịch sử điểm danh">
                        ...
                        <div>
                            ...
                            >
                                <!-- <template v-slot:prev-page="{ options }">
...
:global(#app > div > div > section > section > section > main > div > main > div > div > div > div.ant-card-body > div.ant-row > div.ant-col.ant-col-xs-24.ant-col-sm-24.ant-col-md-12.ant-col-lg-12.ant-col-xl-12.ant-col-xxl-12 > div > div.ant-col.ant-col-xs-12.ant-col-sm-12.ant-col-md-12.ant-col-lg-12.ant-col-xl-12.ant-col-xxl-12.px-5.pl-sm-10 > datepickerwrapper > div) {
    width: 100%;
}
